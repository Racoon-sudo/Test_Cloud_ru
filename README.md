...
Список чисел вы вводите сами. Для корректной работы программы список вводится через "," или ", ", например:
...
* Установить пакет Selenium
```
        pip install selenium
```
* Установить пакет driver-manager
```
